...
} elseif ($_instance->childHasBeenRendered('l4154065754-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4154065754-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4154065754-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4154065754-0');
} else {
    $response = \Livewire\Livewire::mount('tutor.assign-students-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l4154065754-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $tutor->students_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="container px-6 py-10 mx-auto shadow rounded-box">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <h1 class="text-xl font-semibold mb-4"><?php echo e($student['name']); ?></h1>
                                    <div class="inline-flex flex-col gap-1">
                                        ...
                                        <span class="text-gray-400">
                                            <?php echo e($student['visits_made']); ?> de <?php echo e($student['required_visits']); ?> Visitas
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    <div class="inline-flex flex-col items-center gap-4">
                                        <div>
                                            <button type="button" class="btn btn-primary"
                                                wire:click="$emit('openVisitModal', <?php echo e($student['tutor_student_id']); ?>)">
                                                <span class="icon-[tabler--calendar-plus] size-6"></span>
                                                <?php echo e(__('Agendar Visita')); ?>
...
<?php /**PATH C:\laragon\www\practicasisus\resources\views/livewire/tutor/tutor-filter.blade.php ENDPATH**/ ?>