...
} elseif ($_instance->childHasBeenRendered('nZMHlEy')) {
    $componentId = $_instance->getRenderedChildComponentId('nZMHlEy');
    $componentTag = $_instance->getRenderedChildComponentTagName('nZMHlEy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nZMHlEy');
} else {
    $response = \Livewire\Livewire::mount('tutor.tutor-filter');
    $html = $response->html();
    $_instance->logRenderedChild('nZMHlEy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/Admin/tutor-student/index.blade.php ENDPATH**/ ?>