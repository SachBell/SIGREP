...
} elseif ($_instance->childHasBeenRendered('l3795092382-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3795092382-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3795092382-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3795092382-0');
} else {
    $response = \Livewire\Livewire::mount('application-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l3795092382-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/livewire/call-card.blade.php ENDPATH**/ ?>