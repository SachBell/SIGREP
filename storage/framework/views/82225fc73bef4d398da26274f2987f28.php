...
} elseif ($_instance->childHasBeenRendered('l2058564633-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2058564633-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2058564633-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2058564633-0');
} else {
    $response = \Livewire\Livewire::mount('modals.users-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l2058564633-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/html/resources/views/livewire/filters/users-filter.blade.php ENDPATH**/ ?>