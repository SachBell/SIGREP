...
} elseif ($_instance->childHasBeenRendered('l2085807277-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2085807277-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2085807277-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2085807277-0');
} else {
    $response = \Livewire\Livewire::mount('career-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l2085807277-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\practicasisus\resources\views/livewire/career-filter.blade.php ENDPATH**/ ?>