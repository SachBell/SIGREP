...
} elseif ($_instance->childHasBeenRendered('l3519312139-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3519312139-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3519312139-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3519312139-0');
} else {
    $response = \Livewire\Livewire::mount('posts-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l3519312139-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/livewire/posts-filter.blade.php ENDPATH**/ ?>