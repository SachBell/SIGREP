<div class="space-y-4">
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('convenant-modal')->html();
} elseif ($_instance->childHasBeenRendered('l1022558437-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1022558437-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1022558437-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1022558437-0');
} else {
    $response = \Livewire\Livewire::mount('convenant-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l1022558437-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            ...
                            <tr>
                                ...
                                <th class="flex py-5">
                                    ...
                                    <form class="delete-form"
                                        action="<?php echo e(route('convenants.destroy', $convenant->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/livewire/convenant-filter.blade.php ENDPATH**/ ?>