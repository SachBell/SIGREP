...
<select <?php echo e($disabled ? 'disabled' : ''); ?> <?php echo $attributes->merge([
    'class' => 'border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm cursor-pointer',
]); ?>>
    <?php echo e($slot); ?>

</select>
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/components/select-input.blade.php ENDPATH**/ ?>