        ...
        <?php if($hasUpdate): ?>
            <div class="bg-slate-100 py-6 px-5 flex flex-col sm:flex-row justify-between rounded-box gap-5">
                <div class="inline-flex flex-col justify-center gap-2">
                    ...
                    <span class="text-md text-gray-500">Actual: v<?php echo e($currentVersion); ?> | Nueva:
                        v<?php echo e($latestVersion); ?></span>
                </div>
...
<?php /**PATH C:\laragon\www\practicasisus\resources\views/Admin/settings/partials/general.blade.php ENDPATH**/ ?>