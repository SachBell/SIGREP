<div class="space-y-4">
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('career-modal')->html();
} elseif ($_instance->childHasBeenRendered('l3868261296-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3868261296-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3868261296-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3868261296-0');
} else {
    $response = \Livewire\Livewire::mount('career-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l3868261296-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <?php $__currentLoopData = $careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <th class="flex py-5">
                                    ...
                                    <form action="<?php echo e(route('careers.destroy', $career->id)); ?>" class="delete-form"
                                        action="" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/livewire/career-filter.blade.php ENDPATH**/ ?>