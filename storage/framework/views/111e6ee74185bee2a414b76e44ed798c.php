...
} elseif ($_instance->childHasBeenRendered('2wRAh89')) {
    $componentId = $_instance->getRenderedChildComponentId('2wRAh89');
    $componentTag = $_instance->getRenderedChildComponentTagName('2wRAh89');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2wRAh89');
} else {
    $response = \Livewire\Livewire::mount('filters.users-filter');
    $html = $response->html();
    $_instance->logRenderedChild('2wRAh89', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
