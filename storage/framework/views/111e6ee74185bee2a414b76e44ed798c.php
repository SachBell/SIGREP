...
} elseif ($_instance->childHasBeenRendered('m0CLeZE')) {
    $componentId = $_instance->getRenderedChildComponentId('m0CLeZE');
    $componentTag = $_instance->getRenderedChildComponentTagName('m0CLeZE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('m0CLeZE');
} else {
    $response = \Livewire\Livewire::mount('filters.users-filter');
    $html = $response->html();
    $_instance->logRenderedChild('m0CLeZE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
