...
} elseif ($_instance->childHasBeenRendered('l530293769-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l530293769-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l530293769-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l530293769-0');
} else {
    $response = \Livewire\Livewire::mount('users-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l530293769-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\practicasisusGlobal\resources\views/livewire/users-filter.blade.php ENDPATH**/ ?>