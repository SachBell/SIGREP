...
} elseif ($_instance->childHasBeenRendered('l2419957086-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2419957086-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2419957086-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2419957086-0');
} else {
    $response = \Livewire\Livewire::mount('convenant-modal');
    $html = $response->html();
    $_instance->logRenderedChild('l2419957086-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\practicasisus\resources\views/livewire/convenant-filter.blade.php ENDPATH**/ ?>